...
import { ProductsList } from './iu/ProductsList'
...
export const ProductList = () => {
  ...
  const listContent = (() => {
    ...
    return <ProductsList data={data} onDelete={handleDelete} />
  })()

  const ActionButton = () => {
    // Si es admin -> botón para cargar producto
    if (user?.role === 'admin') {
      return (
    ...
    // Si es cliente -> botón para ir al carrito (ELIMINADO EL BOTÓN DE INICIAR SESIÓN)
    return (
